    ...
    <!--   you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple" -->
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="active" class="nav-link" href="diemsv.php">
                    <a href="">
                                ...
                                <div class="table-wrapper">
                    	            ...
                    	            <form method="POST" action="#">
                    	               	<div class="modal-header">						
                    						<h4 class="modal-title"><b>Điểm môn học</b></h4>
                    	            ...
                    	            <table class="table table-striped table-hover">
                    				    ...
                    				    <tbody>
                    				        <?php
                    	                        $sql = "select * from ketqua k 
                    	                        		join sinhvien s on k.masv = s.masv 
                    	                        		join monhoc m on k.mamh = m.mamh 
                    	                        		join svctdt sc on sc.masv = k.masv where s.tentk='".$tentk."' and trangthai='dang ky'";
                    							...
                    							while ($row = mysqli_fetch_array($res)){
                    								...
                    								$result=mysqli_query($conn,$sql_ss);
                    								...
                    								echo '<tr>
                    								    	...
                    								    	<td>';
                    								if ($row['diem']>=5.5) {
                    									$tctichluy = $tctichluy+$row['sotinchi'];
                    	            ...
                    	            <h6>Tổng số tín chỉ tích lũy: <?php echo $tctichluy; ?><h6>
                    	    </div>
                            </div>
                        </div>
                    </div>
