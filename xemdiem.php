                                 ...
                                 <!-- <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-0" style="background-color: white;"> -->
                                        ...
                                        <div class="table-wrapper">
                                                <div class="table-title">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <h2>Danh sách điểm<b> sinh viên</b></h2>
                                                        </div>
                                                ...
                                                <form method="POST" action="#"> 
                                                    <div class="modal-header">                      
                                                        <h4 class="modal-title"><b>Xem điểm</b></h4>
                                                ...
                                                <table class="table table-striped table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            ...
                                                            $mamh = $_GET["id"];
                                                            //$query_sv = "SELECT * FROM ketqua k join sinhvien s on k.masv = s.masv where mamh='".$mamh."'";   
                                                            $query_sv = "SELECT * FROM ketqua k join sinhvien s on k.masv = s.masv join svctdt sc on s.masv = sc.masv where mamh='".$mamh."' and trangthai='dang ky'"; 
                                                ...
                                                <center>
                                                    ...
                                                    <input type="button" class="btn btn-default btnback" data-dismiss="modal" value="Trở về">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $(".btnback").on("click", function(e){
                    e.preventDefault();
                    window.location.href = "http://localhost/change/diem.php";
                });
