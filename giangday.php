                                    ...
                                    <div class="table-wrapper">
                                            ...
                                            <form method="POST" action="#">
                                                <div class="modal-header">                      
                                                    <h4 class="modal-title"><b>Thời khóa biểu giảng dạy</b></h4>
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        while ($row = mysqli_fetch_array($res)){
                                                            $sql_ss="SELECT count(*) as siso from ketqua k join svctdt c on k.masv = c.masv where mamh='".$row["mamh"]."'and trangthai='dang ky'";
