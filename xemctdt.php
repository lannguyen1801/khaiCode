...
<div class="wrapper">
    ...
    <!--   you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple" -->
        ...
        <?php
            ...
            $sql_sv = "select * from sinhvien s join taikhoan t on s.tentk = t.tentk where t.tentk='".$tentk."'";
            $res_sv = mysqli_query($con,$sql_sv);
            if (mysqli_num_rows($res_sv)==1) {
                echo '<div class="sidebar-wrapper">
                            ...
                            <ul class="nav">
                                <li>
                                    <a class="active" class="nav-link" href=dangkyctdt.php>
                                        <i class="pe-7s-graph"></i>
                                        <p>ĐĂNG KÝ CHƯƠNG TRÌNH ĐÀO TẠO</p>
                                    </a>
                                </li>
                                <li class="active">
                 ...
                 echo ' <div class="sidebar-wrapper">
                            ...
                            <ul class="nav">
                                <li>
                                    <a class="active" class="nav-link" href=giangday.php>
                                        <i class="pe-7s-graph"></i>
                                        <p>GIẢNG DẠY</p>
                                    </a>
                                 </li>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <?php
                        ...
                        $res_sv = mysqli_query($con,$sql_sv);
                        if (mysqli_num_rows($res_sv)==1) {
                            echo '<a class="navbar-brand" href="#">SINH VIÊN</a>';
                        }
                        else{
                            echo '<a class="navbar-brand" href="#">GIÁO VIÊN</a>';
                        }   
                    ?>
